...
//   const { message } = useContext(MessageContext); // match ChatView
  

//   // Trigger AI code generation when user sends a message
//  useEffect(() => {
//   if (message?.length > 0) {
...
//     // If AI puts App.js at root, move it into /src
//     if (path === "/App.js") {
...
//   return normalized;
// };
//     // const mergedFiles = { ...Lookup.DEFAULT_FILE, ...result.files };
...
// if (normalizedFiles["/src/App.js"]) {
//   delete Lookup.DEFAULT_FILE["/src/App.jsx"];
// }
//   } catch (err) {
...
//       {loading && (
//         <p className="text-yellow-400 p-2">Generating code... Please wait.</p>
//       )}
...
//   });
//   const normalizeFiles = (files) => {
//   if (!files) return {}; // ⬅️ Prevent crash if files is null/undefined
...
//     mergedFiles = normalizedFiles;
//     } else {
//     mergedFiles = { ...Lookup.DEFAULT_FILE, ...result.files };
//     }
//     setFiles(mergedFiles);
